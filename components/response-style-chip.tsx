...
interface ResponseStyleChipProps {
  responseStyle: "conversational" | "inquisitive" | "direct" | "detailed"
  onEdit: () => void
  onReset: () => void
}
...
const responseStyleDescriptions = {
  conversational: "Friendly, casual tone with light suggestions",
  inquisitive: "Asks clarifying questions to uncover possibilities",
  direct: "Straight to the point, minimal extra commentary",
  detailed: "Thorough, descriptive responses with context",
}

export function ResponseStyleChip({ responseStyle, onEdit, onReset }: ResponseStyleChipProps) {
    ...
    <div className="relative">
      ...
      >
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="text-blue-600">
          ...
          <path d="M14.5 9H14.51" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          <path
        ...
        <span>{responseStyleLabels[responseStyle]}</span>
        <svg
          width="12"
          height="12"
          viewBox="0 0 24 24"
        ...
        <DropdownMenu onClose={() => setIsOpen(false)}>
          <div className="p-3 min-w-[280px]">
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={handleReset} className="text-xs text-blue-600 hover:text-blue-700 font-medium">
                Reset to Conversational
              </button>
            </div>

            <div className="space-y-2">
              <div className="p-2 bg-blue-50 rounded-lg border border-blue-200">
                <div className="font-medium text-blue-900 text-sm mb-1">{responseStyleLabels[responseStyle]}</div>
                <div className="text-xs text-blue-700">{responseStyleDescriptions[responseStyle]}</div>
              </div>
            </div>
